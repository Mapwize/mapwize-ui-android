...
/**
 * This tests the OpeningHours format for isOpen, opensAt and closesAt
 */
public class OpeningHoursTest {
    ...
    public void isOpenTest() {
        ...
        assertTrue(isOpen(daysMock, new TimeInWeek(0, 0, 0)));
    ...
    public void convertDaysToTimeOfWeekTest() {
        assertThat(convertDaysToTimeOfWeek(daysMock, true), is(Arrays.asList(0, 10000, 11400, 20900, 30900, 40900, 50000, 60000)));
